...
def teacher_tab_take_attendance():
    ...
    if st.session_state.attendance_images:
        ...
        with c2:
            ...
            if st.button('Run Face Algorithm', width='stretch',type='secondary', icon=':material/analytics:'):
                with st.spinner("Deep scanning classroom photos....."):
                    ...
                    enrolled_res = supabase.table('subjects_students').select("*, students(*)").eq('subject_id', selected_subject_id)
