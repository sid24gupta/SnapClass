...
from src.components.dialog_voice_attendance import voice_attendance_dailog
...
def teacher_tab_take_attendance():
    ...
    with c2:
        if st.button('Run Face Algorithm', width = 'stretch',type = 'secondary', icon = ':material/analytics:', disabled = not has_photos):
    ...
    with c3:
        if st.button('Use Voice Attendance', width='stretch',type='primary', icon=':material/mic:'):
            voice_attendance_dailog(selected_subject_id)
